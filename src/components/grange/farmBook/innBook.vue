  ...
  <div>
    ...
    <div class="innBook">
      ...
      <div class="datapicker clear">
        <input type="text" readonly v-model="value1" placeholder="请选择日期" @click="showPopup(1)">
        <span>入住</span>
        <input type="text" readonly v-model="value2" placeholder="请选择日期" @click="showPopup(2)" :disabled="this.value1==''">
        <span>离店</span>
        <p>共{{days}}晚</p>
      </div>
      <!--中间分割块-->
  ...
  export default {
    ...
    data() {
      return {
        ...
        minDate: new Date(),
        value1: new Date(),//入住日期
        value2: new Date(),//离店日期
        date1: false,
        date2: false,
        days: 1,
        show2: false,
