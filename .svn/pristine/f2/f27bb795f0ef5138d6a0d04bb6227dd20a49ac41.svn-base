<template>
  <div class="wantedDetail">
    ...
    <RimGrange :foodList="getFoodList" :playList="getPlayList" :stayList="getStayList" v-if="RimGrange"/>
    <Link/>
    <!--<Bootom/>-->
    ...
    methods: {
      init() {
        ...
        this.$http.post('appServiceFarmhouse/getRentingHouseDetail', {
          ...
          if (res.data.getFoodList && res.data.getPlayList && res.data.getStayList) {
            this.RimGrange=true
          }
          console.log(res);
        })
